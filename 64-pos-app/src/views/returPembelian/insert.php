...
<div class="row">
  <div class="col">
    ...
    <form class="bg-body rounded shadow-sm p-3" id="form" action="<?= BASEURL . '/retur-pembelian/insert' ?>"
      method="post">
      <div class="mb-3 row">
      ...
      <?php if (count($pembelianDtl)): ?>
              ...
              <tbody>
                ...
                foreach ($pembelianDtl as $row): ?>
                  <tr>
                    ...
                    <td>
                      <input type="number" value="0" name="barang[<?= $row['id_pembeliandtl'] ?>]" size="10">
                    </td>
                    <td>
        ...
        <div class="mb-3 row">
          <div class="col-2">
            <button onclick="addData('form', '<?= BASEURL . '/retur-pembelian/insert-data' ?>')" type="button"
