...
<div class="row">
  <div class="col">
    ...
    <form class="bg-body rounded shadow-sm p-3" id="form" action="<?= BASEURL . '/pembelian/insertdata' ?>"
      method="post">
      <div class="mb-3 row">
        <label for="nama_pembelian" class="col-md-2 col-form-label">Barang</label>
        <div class="col-md-5">
          <select class="bg-body form-control select2" name="barang" data-placeholder="Pilih Satu Barang">
